    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          _statGrid({
            '总章节': s.total.toString(),
            '已通过': s.approved.toString(),
            '待审核': s.pendingReview.toString(),
            '已拒绝': s.needsRewrite.toString(),
          }),
          const SizedBox(height: 24),
          _sectionTitle('其他'),
          const SizedBox(height: 8),
          _statGrid({
            '自动过': s.autoPassed.toString(),
            '人工编': s.humanEdited.toString(),
            '误报': s.falsePositive.toString(),
          }),
